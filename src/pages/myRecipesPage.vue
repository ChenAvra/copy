<template>
 <div>
    <b-alert variant="success" dismissible fade :show="showDismissibleAlert"  @dismissed="showDismissibleAlert=false">
      You don't have your own recipes :(
    </b-alert>
    <recipePreviewList class="recipePreview" :recipes="recipes" title='Your recipes'></recipePreviewList>
 </div> 
</template>
...
export default {
 ...
 components:{
  ...
  methods:{
      async getMyRecipes(){
        let url = "http://localhost:3000/users/myRecepies/getPreview";
