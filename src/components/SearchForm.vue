...
<div>
<!-- <div>
  <b-navbar type="light" variant="light" style="background-color: #e3f2fd;">
    <b-nav-form>
        <b-form-input v-model="query" class="mr-sm-2" placeholder="Search Query"></b-form-input>
        <div>
            <b-form-select class="mr-sm-2" v-model="selectedResultsNum" :options="ResultsOptions">
          ...
          <div>
            <b-form-select class="mr-sm-2" v-model="selectedSort" :options="SortOptions">
                <template v-slot:first>
         ...
         <div>
             <b-button variant="outline-primary" class="my-2 my-sm-0" type="submit" v-on:click=onClick>Search</b-button>
         </div>
    </b-nav-form>
  </b-navbar>
</div> -->
    <h3> Let's Find The Best Recipe For You! </h3>
    <br>
